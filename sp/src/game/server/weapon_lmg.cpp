...
ConVar sk_lmg_firerate("sk_lmg_firerate", "0.075");
...
public:
	...
	int				GetMinBurst() { return 0; }
	int				GetMaxBurst() { return 1; }

	virtual void	Equip(CBaseCombatCharacter* pOwner);
	bool			Reload();

	float			GetFireRate() { return sk_lmg_firerate.GetFloat(); } // RPS, 60sec/800 rounds = 0.075
	...
	virtual const Vector& GetBulletSpread()
	{
		...
		static Vector aimingCone = VECTOR_CONE_2DEGREES;
		static Vector plrDuckCone = VECTOR_CONE_3DEGREES;
		static Vector plrStandCone = VECTOR_CONE_15DEGREES;
		static Vector plrMoveCone = VECTOR_CONE_15DEGREES;
...
acttable_t CWeaponLMG::m_acttable[] =
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CWeaponLMG::Equip(CBaseCombatCharacter* pOwner)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponLMG::FireNPCPrimaryAttack(CBaseCombatCharacter* pOperator, Vector& vecShootOrigin, Vector& vecShootDir)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponLMG::Operator_ForceNPCFire(CBaseCombatCharacter* pOperator, bool bSecondary)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponLMG::Operator_HandleAnimEvent(animevent_t* pEvent, CBaseCombatCharacter* pOperator)
{
	switch (pEvent->event)
	{
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponLMG::GetPrimaryAttackActivity()
{
	if (m_nShotsFired < 2)
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponLMG::SecondaryAttack()
{
}
...
// Output : int
//-----------------------------------------------------------------------------
int CWeaponLMG::WeaponRangeAttack2Condition(float flDot, float flDist)
{
	return COND_NONE;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t* CWeaponLMG::GetProficiencyValues()
{
