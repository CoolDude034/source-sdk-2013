...
class CWeaponRemington870 : public CBaseHLCombatWeapon
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponRemington870, CBaseHLCombatWeapon);
...
acttable_t	CWeaponRemington870::m_acttable[] =
{
...
{
	return CWeaponRemington870::m_acttable;
}
...
// Input  : *pOperator - 
//-----------------------------------------------------------------------------
void CWeaponRemington870::FireNPCPrimaryAttack(CBaseCombatCharacter* pOperator, bool bUseWeaponAngles)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponRemington870::Operator_ForceNPCFire(CBaseCombatCharacter* pOperator, bool bSecondary)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponRemington870::Operator_HandleAnimEvent(animevent_t* pEvent, CBaseCombatCharacter* pOperator)
{
	switch (pEvent->event)
	{
...
//-----------------------------------------------------------------------------
float CWeaponRemington870::GetMinRestTime()
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
float CWeaponRemington870::GetMaxRestTime()
{
	if (hl2_episodic.GetBool())
	{
		if (GetOwner() && GetOwner()->Classify() == CLASS_COMBINE || GetOwner() && GetOwner()->Classify() == CLASS_METROPOLICE)
...
//-----------------------------------------------------------------------------
float CWeaponRemington870::GetFireRate()
{
	if (hl2_episodic.GetBool())
	{
		if (GetOwner() && GetOwner()->Classify() == CLASS_COMBINE || GetOwner() && GetOwner()->Classify() == CLASS_METROPOLICE)
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponRemington870::StartReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponRemington870::Reload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponRemington870::FinishReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponRemington870::FillClip(void)
{
	CBaseCombatCharacter* pOwner = GetOwner();
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponRemington870::Pump(void)
{
	CBaseCombatCharacter* pOwner = GetOwner();
...
//
//-----------------------------------------------------------------------------
void CWeaponRemington870::DryFire(void)
{
	WeaponSound(EMPTY);
...
//
//-----------------------------------------------------------------------------
void CWeaponRemington870::PrimaryAttack(void)
{
...
//
//-----------------------------------------------------------------------------
void CWeaponRemington870::SecondaryAttack(void)
{
	// Only the player fires this way so we can cast
	CBasePlayer* pPlayer = ToBasePlayer(GetOwner());
...
//-----------------------------------------------------------------------------
void CWeaponRemington870::ItemPostFrame(void)
{
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CWeaponRemington870::CWeaponRemington870(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponRemington870::ItemHolsterFrame(void)
{
	// Must be player held
