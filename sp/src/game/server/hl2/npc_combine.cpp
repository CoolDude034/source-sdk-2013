...
ConVar sk_shield_destroy_shield_instead_of_drop("sk_shield_destroy_shield_instead_of_drop", "0", FCVAR_HIDDEN | FCVAR_SPONLY);
ConVar sk_shield_spawn_chance("sk_shield_spawn_chance", "0", FCVAR_HIDDEN | FCVAR_SPONLY);
...
// TODO: generated by ChatGPT yes, ik but i fix this later (when HL3 comes out)
void InterpolateAngles(const QAngle& src, const QAngle& dest, float factor, QAngle& out)
{
	out.Init(
...
ConVar npc_combine_is_alt_capable_override("npc_combine_is_alt_capable_override", "0", FCVAR_HIDDEN);
ConVar npc_combine_is_gren_capable_override("npc_combine_is_gren_capable_override", "0", FCVAR_HIDDEN);
